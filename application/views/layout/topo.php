...
<head>
    ...
    <title>Fast Mael | Restaurantes App</title>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet"
          href="<?php echo base_url('assets/template'); ?>/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet"
    ...
    <link rel="stylesheet"
          href="<?php echo base_url('assets/template'); ?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo base_url('inicial');?>" class="logo">
            ...
            <span class="logo-lg"><b>Fast </b>Meal</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo base_url('assets/template'); ?>/dist/img/user3-128x128.jpg"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo base_url('assets/template'); ?>/dist/img/user4-128x128.jpg"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs  text-uppercase"><?php echo $_SESSION['usuario']?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo base_url('assets/template'); ?>/dist/img/user2-160x160.jpg" class="img-circle"
                         alt="User Image">
                </div>
