...
<div class="box box-primary col-lg-12 ">
    <div class="box-header
        ...
        <h3 class="box-title ">Cadastro de Mesas</h3>
    ...
    <!-- form start -->
    <form role="form" action="<?php echo site_url('mesa/') . $acao; ?>" method="post" enctype="multipart/form-data">
        <?php foreach ($ver as $registro) : ?>
            ...
            <div class="box-body fluid border border-primary center">
                ...
                <div class="row col-lg-12">
                    <div class="form-group col-lg-8">
                        <label for="exampleInputEmail1">Nome do mesa:</label>
            ...
            <div class="form-group col-lg-4">
                ...
                <div class="box-footer mb-2 p-3 col-lg-5">
                    <a href="<?php echo site_url('mesa') ?>">Voltar</a>
                </div>
            </div>
